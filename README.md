...
## Screenshot
<img src="vintasoft-twain-simple-demo.png" alt="VintaSoft TWAIN Simple Demo">
...
3. Build the project ("TwainSimpleDemo.Net7.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build TwainSimpleDemo.Net7.csproj
   ```
